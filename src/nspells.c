...
{"summon",         spell_summon        , SPELL, 75, 50, 3, POS_STANDING, TAR_CHAR_WORLD | TAR_NOT_SELF, FALSE, MAG_MANUAL,
                                         ...
                                         NULL,
	                                 NULL},
{"ventriloquate",  NULL                , SPELL, 0, 0, 0, 0, 0, 0, 0, CLASS_UNDEFINED, 0, CLASS_UNDEFINED, 0, NULL, NULL},
...
{"group heal",     NULL                , SPELL, 80, 60, 5, POS_STANDING, TAR_IGNORE, FALSE, MAG_GROUPS,
                                         ...
                                         NULL,
	                                 NULL},
{"group recall",   NULL                , SPELL, 0, 0, 0, 0, 0, 0, 0, CLASS_UNDEFINED, 0, CLASS_UNDEFINED, 0, NULL, NULL},
...
{"darkness",       NULL                , SPELL, 30, 5, 4, POS_STANDING, TAR_IGNORE, FALSE, MAG_ROOMS,
                                         ...
                                         NULL,
	                                 NULL},
{"backstab",       do_backstab         , SKILL, 0, 0, 0, 0, 0, 0, 0, CLASS_THIEF, 3, CLASS_UNDEFINED, 0, NULL, NULL},
{"bash",           do_bash             , SKILL, 0, 0, 0, 0, 0, 0, 0, CLASS_WARRIOR, 12, CLASS_UNDEFINED, 0, NULL, NULL},
{"hide",           do_hide             , SKILL, 0, 0, 0, 0, 0, 0, 0, CLASS_THIEF, 5, CLASS_UNDEFINED, 0, NULL, NULL},
{"kick",           do_kick             , SKILL, 0, 0, 0, 0, 0, 0, 0, CLASS_WARRIOR, 1, CLASS_UNDEFINED, 0, NULL, NULL},
{"pick lock",      NULL                , SKILL, 0, 0, 0, 0, 0, 0, 0, CLASS_THIEF, 2, CLASS_UNDEFINED, 0, NULL, NULL},
{"whirlwind",      do_whirlwind        , SKILL, 0, 0, 0, 0, 0, 0, 0, CLASS_WARRIOR, 16, CLASS_UNDEFINED, 0, NULL, NULL},
{"rescue",         do_rescue           , SKILL, 0, 0, 0, 0, 0, 0, 0, CLASS_WARRIOR, 3, CLASS_UNDEFINED, 0, NULL, NULL},
{"sneak",          do_sneak            , SKILL, 0, 0, 0, 0, 0, 0, 0, CLASS_THIEF, 1, CLASS_UNDEFINED, 0, NULL, NULL},
{"steal",          do_steal            , SKILL, 0, 0, 0, 0, 0, 0, 0, CLASS_THIEF, 4, CLASS_UNDEFINED, 0, NULL, NULL},
{"track",          do_track            , SKILL, 0, 0, 0, 0, 0, 0, 0, CLASS_THIEF, 6, 
                                                                     CLASS_WARRIOR, 9, NULL, NULL},
{"bandage",        do_bandage          , SKILL, 0, 0, 0, 0, 0, 0, 0, CLASS_WARRIOR, 7, CLASS_UNDEFINED, 0, NULL, NULL},
{ NULL,            NULL                , SPELL, 0, 0, 0, 0, 0, 0, 0, CLASS_UNDEFINED, 0, CLASS_UNDEFINED, 0, NULL, NULL}
};
